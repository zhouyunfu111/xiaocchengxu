...
<style lang="scss" scoped>
	...
	$u-upload-deletable-bgColor: rgb(255, 33, 33) !default;
	$u-upload-deletable-height: 25px !default;
	...
	$u-upload-success-border-width: 14px !default;
	...
	$u-upload-success-icon-bottom:-14px !default;
	$u-upload-success-icon-right:-14px !default;
