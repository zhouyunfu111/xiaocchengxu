...
export function shopSave(data){ 
  return request.post("shop/save",data);
...
export function shopList(data){ 
  return request.get("shop/list",data, {noAuth: true});
}
 ...
 * 专属客服
*/
export function supportStaff(data){ 
  return request.get("user/support/staff",{},{noAuth:true});
}
