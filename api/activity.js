 ...
 * 首页军师菜单/食材分类
*/
export function foodMenuList(type,data){
  return request.get('food/menu/list/'+type,data,{noAuth:true})
}

/**
 * 获取详情接口
*/
export function foodMenuInfo(id){
  return request.get('food/menu/info/'+id,data,{noAuth:true})
}