 ...
 * 查看已开通的销售区域
 */
export function salesAreaListTree(){
	return request.get('salesArea/list/tree')
}
...
export function productRank(data){
	return request.get('product/rank',data)
}
 ...
 * 检测城市是否在销售区域内
 */
export function salesArea(id){
	return request.get('salesArea/'+id)
}